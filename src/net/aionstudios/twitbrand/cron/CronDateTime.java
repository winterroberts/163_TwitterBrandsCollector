...
public class CronDateTime {
	...
	public boolean matchesNow() {
		return hasMinute(DateTimeUtils.getCronMinute())&&hasHour(DateTimeUtils.getCronHour())&&hasDayOfMonth(DateTimeUtils.getCronDayOfMonth())&&hasMonth(DateTimeUtils.getCronMonth())&&hasDayOfWeek(DateTimeUtils.getCronDayOfWeek())&&hasYear(DateTimeUtils.getCronYear());
	}
